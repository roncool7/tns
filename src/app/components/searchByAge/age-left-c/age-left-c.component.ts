...
@Component({
  selector: 'app-age-left-c',
  templateUrl: './age-left-c.component.html',
  styleUrls: ['./age-left-c.component.css'],
})
export class AgeLeftCComponent implements OnInit {
  public productsUntil5Years: ProductModel[];
  ...
  ngOnInit() {
    this.loader = true;
    setTimeout(async () => {
      this.productsUntil5Years = await this.myProductsAgeService.getProductsUntil5();
      this.loader = false;
    }, 2000);
  }
  ...
  public getSliderValue(value) {
    ...
    setTimeout(async () => {
      const response = await this.myProductsAgeService.filterSlider5(value);
      ...
      this.productsUntil5Years = response;
      this.loader = false;
    }, 2000);
  }
  ...
  public fromHighToLow() {
    ...
    setTimeout(async () => {
      ...
      const response = await this.myProductsAgeService.highToLow5();
      this.productsUntil5Years = response;
      this.loader = false;
    }, 2000);
  }
  ...
  public fromLowToHigh() {
    ...
    setTimeout(async () => {
      ...
      const response = await this.myProductsAgeService.lowToHigh5();
      this.productsUntil5Years = response;
      this.loader = false;
    }, 2000);
  }
